...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var dataController: Rustavi2DataController?

    public static var rootViewCtrl : UIViewController? = {
        let delegate = UIApplication.shared.delegate as! AppDelegate?
        return delegate?.window?.rootViewController
    }()
    
    public static var dataController: Rustavi2DataController? = {
        let delegate = UIApplication.shared.delegate as! AppDelegate?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        self.dataController = Rustavi2DataController(completionClosure: {
            print("Data controller is inited")
        })
        
        // Fetch data(News) once in 15 min.
...
//        self.window?.makeKeyAndVisible()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Rustavi2Tv")
